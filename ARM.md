...
---
Les opérateurs observent le réseau avec des probe pour pouvoir faire de la classification, de la prédiction. Ils'utilisent aussi leurs application de gestion de compte pour récolter des données notamment au delà de ce qui concerne le réseau de l'opérateur. Les opérateurs achetant leur matériel chez des constructeurs comme Nokia, Ericson, Huwei, les metriques ne sont pas toujours les mêmes ils ont donc des spécialistes sur chaques technolo
...
100Mbps
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjUzNDc2MzE4XX0=
-->